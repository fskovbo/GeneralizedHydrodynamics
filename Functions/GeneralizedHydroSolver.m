...
methods (Access = public)
    ...
    function [theta_t, u_t, w_t] = propagateTheta(obj, theta_init, t_array)
        ...
        w_t             = cell(1, Nsteps+1);
        w_init          = GHDtensor( repmat( obj.rapid_grid, 1, 1, obj.Ntypes, 1, obj.M) );
        w_t{1}          = w_init;
        ...
        switch obj.stepOrder
            case 1
                % Set stepfunction
                stepFunc    = @(th_aux, th_prev, u_prev, w_prev, t, dt) obj.performFirstOrderStep(th_aux, th_prev, u_prev, w_prev, t, dt);                              
            ...
            case 2
                % Set stepfunction
                stepFunc    = @(th_aux, th_prev, u_prev, w_prev, t, dt) obj.performSecondOrderStep(th_aux, th_prev, u_prev, w_prev, t, dt);
        ...
        for n = 1:Nsteps
            ...
            [theta, theta_aux, u, w] = stepFunc(theta_aux, theta, u, w, t_array(n), dt);
            theta_t{n+1}  = theta;
            u_t{n+1}      = u;
            w_t{n+1}      = w;
...
methods (Access = protected)
    ...
    function [theta_next, theta_tmp, u_next, w_next] = performFirstOrderStep(obj, theta, theta_prev, u_prev, w_prev, t, dt)            
    ...
    function [theta_next, theta_mid, u_next, w_next] = performSecondOrderStep(obj, theta_mid, theta_prev, u_prev, w_next, t, dt)
        % Calculate theta^[n+1] using the filling (theta) at the midpoint
        % between theta^[n] and theta^[n+1].
        [theta_next, u_next, w_next] = step2(obj, theta_mid, theta_prev, u_prev, w_next, t, dt);
        ...
        theta_mid  = step2(obj, theta_next, theta_mid, u_prev, w_next, t+dt/2, dt);
